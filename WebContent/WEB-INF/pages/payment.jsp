  ...
  <body>
    ...
    <div class="row">
      ...
      <div class="col-sm-8">
        ...
        <h1 style="margin-buttom:20px;">Payment</h1>
      ...
      <div class="demo-container">
        ...
        <div class="form-container active">
            <form id="credit-card-form" action="billing.html" method="post">
                ...
                <button type="submit" id="credit-card-form-submit"><span>Next: Billing</span></button>
      ...
      <!-- checkout start-->
        ...
        <div class="checkout-content">
          ...
          <a href="payment.html"><button class="checkout" style="display:none;">Checkout</button></a>
        </div>
      </div><!-- order-sum -->
      </div><!-- col-sm -->
      <!-- check out end -->
    ...
    <script src="js/jscard.js"></script>
    <script>
        new Card({
