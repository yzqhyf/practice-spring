  ...
  <body>
    ...
    <div class="row">
      ...
      <div class="shipping-address">
        ...
        <form id="shipping-form" action="index.html">
          <table align="center">
            <tr>
              <td>First Name&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
        ...
        <input type="submit" id="shipping-form-submit" style="display:none;">
      </form>
      </div>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title" style="color:darkblue;">Your order has been received.</h4>
        </div>
        <div class="modal-body">
          <p>Thank you for your purchase!</p>
          <div class="receipt-detail">
          	<p>Your order#: <% String alphabet="ABCDEFGHIJKLMNOPQRSTUVWXYZ";
          					int getCharacter=(int)(Math.random()*26);
          					String number="1234567890";
          					int getNumber1=(int)(Math.random()*10);
          					int getNumber2=(int)(Math.random()*10);
          					int getNumber3=(int)(Math.random()*10);
          					int getNumber4=(int)(Math.random()*10);
          					int getNumber5=(int)(Math.random()*10);
          					int getNumber6=(int)(Math.random()*10);
          					String s=alphabet.substring(getCharacter, getCharacter+1)+number.substring(getNumber1, getNumber1+1)+
          							number.substring(getNumber2, getNumber2+1)+
          							number.substring(getNumber3, getNumber3+1)+number.substring(getNumber4, getNumber4+1)+
          							number.substring(getNumber5, getNumber5+1)+number.substring(getNumber6, getNumber6+1);
							%><%=s %>
					</p>
					<p><b style="">Send receipt to email:</b> <input type="text"></p>		
			
          </div>
          
        </div>
        <div class="modal-footer">
          <a href="index.html"><button type="button" class="btn btn-default">Close</button></a>
        </div>
      </div>
